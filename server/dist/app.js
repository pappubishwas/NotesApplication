...
mongoose_1.default.connect(process.env.MONGO_URI || "", {})
    ...
    .catch(function (err) { return console.error("Mongo connection error:", err); });
/* Passport Google */
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (!email)
                    return [2 /*return*/, done(null, false, { message: "No email from Google" })];
            ...
            case 4:
                err_1 = _c.sent();
                return [2 /*return*/, done(err_1, undefined)];
