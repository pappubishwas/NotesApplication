    ...
    <div className="flex h-screen bg-gray-100 font-sans">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center px-3 py-2 rounded-md ${
                isActive ? "bg-teal-600" : "text-gray-300"
              } hover:bg-gray-700`
            }
          >
            All Notes
          ...
          <div className="mt-2 space-y-1">
            {notes.map((note) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `block w-full text-left px-3 py-2 text-sm rounded-md truncate ${
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-4 sm:p-6">
          {/* Pass both the notes and the function to refresh them */}
          <Outlet context={{ notes, refreshNotes: fetchAllNotes }} />
        </main>
      </div>
